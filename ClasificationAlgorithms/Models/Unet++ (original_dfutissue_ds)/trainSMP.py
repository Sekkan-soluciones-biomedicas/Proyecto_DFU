...
def main(NUM_EPOCHS=NUM_EPOCHS):
    ...
    if LOAD_MODEL:
        load_checkpoint(torch.load("output_assets_model/best_model_checkpoint_UnetPP_smp.pth", weights_only=True), model)
    ...
    if SAVE_MODEL:
        ...
        pd.DataFrame([parameters]).to_csv('output_assets_model/parameters_UnetPP_smp.csv', index=False)
