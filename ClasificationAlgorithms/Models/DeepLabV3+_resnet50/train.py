...
def main(NUM_EPOCHS=NUM_EPOCHS):
    ...
    if LOAD_MODEL:
        load_checkpoint(torch.load("C:/Users/am969/Documents/DFU_Proyect/ClasificationAlgorithms/Models/DeepLabV3+/output_assets_model/best_model_checkpoint_UnetPP_smp.pth",  weights_only=True), model)
