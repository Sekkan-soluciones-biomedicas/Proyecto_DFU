...
def objective(trial):
    ...
    weight_decay = trial.suggest_loguniform("weight_decay", 1e-6, 1e-5) if optimizer_name == "AdamW" else None
...
def main():
    ...
    with open("output_assets_model/Optuna/optuna_best_hyp_2nd_train.json", "w") as f:
